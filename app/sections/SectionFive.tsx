...
export default function SectionFive() {
  return (
    <div className='p-medium-padding flex flex-col items-center gap-10 bg-white-abstract-pattern-2 bg-no-repeat bg-cover text-black bg-center md:py-[100px] lg:py-[100px]'>
