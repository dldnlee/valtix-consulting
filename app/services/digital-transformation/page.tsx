  ...
  return (
    <div className="pt-[80px] bg-white">
      ...
      <div className="p-default-padding flex flex-col gap-10">
        <h1 className="text-3xl">Digital Transformation</h1>
        <p className="text-md w-[530px] leading-8">In the digital age, staying competitive requires embracing technology. Our Digital Transformation services integrate cutting-edge technologies like AI and IoT to revolutionize your operations and create new value propositions.</p>
      </div>
