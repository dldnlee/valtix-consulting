  ...
  return (
    <div className="pt-[80px] bg-white">
      ...
      <div className="p-default-padding flex flex-col gap-10">
        <h1 className="text-3xl">Operational Efficiency</h1>
        <p className="text-md w-[540px] leading-8">Enhance your company&apos;s productivity and efficiency with our Operational Efficiency services. We focus on streamlining processes and implementing lean practices that significantly reduce waste and enhance value to your customers.</p>
      </div>
