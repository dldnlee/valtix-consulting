...
export default function SectionFive() {
  return (
    <div className="digital-transformation-bg flex flex-col items-center justify-center lg:p-default-padding md:p-medium-padding lg:py-[120px] md:py-[120px] text-white gap-20">
